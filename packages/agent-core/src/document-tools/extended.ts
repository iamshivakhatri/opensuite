...
export const createDocumentInsertPageBreakTool = () => tool(DOCUMENT_TOOL_NAMES.insertPageBreak, DOCX_ENGINE_CAPS.insertPageBreak, "Insert a page break at a body location.", { type: "object", properties: { placement }, required: ["placement"], additionalProperties: false });
...
export const createDocumentSetPageSetupTool = () => tool(DOCUMENT_TOOL_NAMES.setPageSetup, DOCX_ENGINE_CAPS.setPageSetup, "Set page margins, paper size, or orientation.", { type: "object", properties: { topMarginTwips: { type: "number" }, rightMarginTwips: { type: "number" }, bottomMarginTwips: { type: "number" }, leftMarginTwips: { type: "number" }, paperSize: { type: "string", enum: ["letter", "a4"] }, orientation: { type: "string", enum: ["portrait", "landscape"] } }, additionalProperties: false });
export const createDocumentSetHeaderFooterTextTool = () => tool(DOCUMENT_TOOL_NAMES.setHeaderFooterText, DOCX_ENGINE_CAPS.setHeaderFooterText, "Set or clear header or footer text.", { type: "object", properties: { kind: { type: "string", enum: ["header", "footer"] }, text: { type: "string", description: "Omit to clear" } }, required: ["kind"], additionalProperties: false });
