...
import {
  ...
  createDocumentSetTableColumnWidthsTool,
...
import {
  createDocumentDeletePageBreakTool,
  createDocumentDeletePictureTool,
  createDocumentInsertPageBreakTool,
  createDocumentInsertTableRowTool,
  createDocumentInsertPictureTool,
  createDocumentReplacePictureTool,
  createDocumentSetContentControlTextTool,
  createDocumentSetHeaderFooterTextTool,
  createDocumentSetHyperlinkTool,
  createDocumentSetPageNumberTool,
  createDocumentSetPageSetupTool,
  createDocumentSetParagraphsListTool,
  createDocumentSetPictureSizeTool,
} from "./extended.js";
...
export type {
  ...
  DocumentSetTableCellShadingInput,
  DocumentSetTableColumnWidthsInput,
...
export {
  createDocumentDeletePageBreakTool, createDocumentDeletePictureTool,
  createDocumentInsertPageBreakTool, createDocumentInsertPictureTool,
  createDocumentInsertTableRowTool,
  createDocumentReplacePictureTool, createDocumentSetContentControlTextTool,
  createDocumentSetHeaderFooterTextTool, createDocumentSetHyperlinkTool,
  createDocumentSetPageNumberTool, createDocumentSetPageSetupTool,
  createDocumentSetParagraphsListTool, createDocumentSetPictureSizeTool,
} from "./extended.js";
...
export { advanceDocumentWorkingState, createDocumentRunState, createDocumentToolContext, recordDocumentInspection } from "./run-state.js";
export type { DocumentRunState, DocumentToolContextOptions, DocumentWorkingState } from "./run-state.js";
...
export function mutableDocumentCapabilities(): RuntimeCapabilities {
  return createCapabilities(
    ...
    DOCX_ENGINE_CAPS.setTableColumnWidths,
    DOCX_ENGINE_CAPS.setTableCellShading,
    DOCX_ENGINE_CAPS.insertTableRows,
    DOCX_ENGINE_CAPS.insertTableRow,
    ...
    DOCX_ENGINE_CAPS.setContentControlText,
    DOCX_ENGINE_CAPS.setParagraphsList,
    DOCX_ENGINE_CAPS.setHyperlink,
    DOCX_ENGINE_CAPS.insertPicture,
    DOCX_ENGINE_CAPS.deletePicture,
    DOCX_ENGINE_CAPS.setPictureSize,
    DOCX_ENGINE_CAPS.replacePicture,
    DOCX_ENGINE_CAPS.insertPageBreak,
    DOCX_ENGINE_CAPS.deletePageBreak,
    DOCX_ENGINE_CAPS.setPageSetup,
    DOCX_ENGINE_CAPS.setHeaderFooterText,
    DOCX_ENGINE_CAPS.setPageNumber,
  );
}
